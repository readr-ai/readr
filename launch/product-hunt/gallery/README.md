...
| 5 | `05-three-ways-to-turn-a-page.png` | Feature: Reading themes/layouts | **Three ways to turn a page.** "Scroll, single page, or a two-page spread — in Paper, Sepia & Dark." | m02 (macOS sepia two-page spread) |
